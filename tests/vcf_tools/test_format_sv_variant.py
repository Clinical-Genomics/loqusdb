...
def test_format_indel(del_variant, individuals, ind_positions, case_id):
    ## GIVEN a SV deletion
    ...
    assert formated_variant['chrom'] == del_variant.CHROM
    assert formated_variant['end_chrom'] == del_variant.CHROM
    assert formated_variant['pos'] == del_variant.POS
    assert formated_variant['end'] == del_variant.INFO['END']
    assert formated_variant['sv_len'] == abs(del_variant.INFO['SVLEN'])
    
    
    assert formated_variant['ref'] == del_variant.REF
    assert formated_variant['alt'] == del_variant.ALT[0]
...
def test_format_small_ins(small_insert_variant, individuals, ind_positions, case_id):
...
def test_format_insertion(insertion_variant, individuals, ind_positions, case_id):
    ## GIVEN a small insertion (This means that the insertion is included in ALT field)
...
def test_format_dup_tandem(duptandem_variant, individuals, ind_positions, case_id):
    ## GIVEN a small insertion (This means that the insertion is included in ALT field)
...
def test_format_translocation(translocation_variant, individuals, ind_positions, case_id):
    ## GIVEN a small insertion (This means that the insertion is included in ALT field)
